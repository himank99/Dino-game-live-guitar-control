...
white = 255,255,255
black = 0,0,0
#os.system("open -a Terminal.app python3 predict.py")

appscript.app('Terminal').do_script('python3 Desktop/dino/predict.py')

#os.system("gnome-terminal -e 'bash -c \"python3 predict.py; exec bash\"'")
...
obstacles = []
pygame.time.set_timer(USEREVENT+1, random.randrange(5000,5500)) #user event which triggers after 3sec to 3.5sec to create obstacles on the ground
IPC_FIFO_NAME = "ipc1"
